...
class EARightSideMenu: UIViewController , NVActivityIndicatorViewable  {
...
extension EARightSideMenu : UICollectionViewDelegate ,UICollectionViewDelegateFlowLayout, UICollectionViewDataSource
{
...
//        cell.imgOfFilterEvent.layer.masksToBounds = false
//        cell.imgOfFilterEvent.layer.borderWidth = 1.0
//        cell.imgOfFilterEvent.layer.borderColor = UIColor.black.cgColor;
//        cell.imgOfFilterEvent.clipsToBounds = true;
...
extension EARightSideMenu: RangeSeekSliderDelegate {
