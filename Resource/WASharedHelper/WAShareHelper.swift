...
class WAShareHelper: NSObject {
    ...
    class func goToHomeController(vcIdentifier: String, storyboardName: String, navController: UINavigationController?, leftMenuIdentifier: String , rightMenuIdentifier : String) {
